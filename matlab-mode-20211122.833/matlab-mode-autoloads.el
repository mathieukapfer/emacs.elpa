...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "matlab" '("ml-fl-anchor-limit" "matlab-" "gud-matlab-debug-active")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "matlab-scan" '("mlf-" "matlab-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "matlab-syntax" '("matlab-")))
